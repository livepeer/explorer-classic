...
;(async () => {
  ...
  const client = await createApolloClient(async () => {
    ...
    const controllers = {
      1: '0xf96d54e490317c557a967abfa5d6e33006be69b3',
      4: '0x37dC71366Ec655093b9930bc816E16e6b587F968',
    }
  ...
  if (isProd) {
    ...
    script.onload = () => {
      ...
      window.gtag('config', 'UA-111259858-1')
    }
    script.src = `https://www.googletagmanager.com/gtag/js?id=UA-111259858-1`
  }
